...
public class HandImage {
	...
	public HandImage(Point location, Card card1, Card card2) {
		_card1 = new Image(new Rectangle(location.x, location.y, 1280, 551), "src/imgs/cards.jpeg");
		_card2 = new Image(new Rectangle(location.x + 25 /*testar*/, location.y, 1280, 551), "src/imgs/cards.jpeg");
